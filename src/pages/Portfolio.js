...
const Portfolio = (props) => {
    ...
    <div class="main">
        ...
        <div class="row">
            <div class="column">
                <div class="content">
                <img src="https://pbs.twimg.com/profile_images/1461700151383400450/3Kwlnvl__400x400.png" alt="Gitcoin" style="width:100%"></img>
        ...
        <div class="column">
            <div class="content">
            <img src="https://gateway.pinata.cloud/ipfs/QmfQvb7QQG5DE6m8tFURE5Uuhu7dRU7TEaxRcSutmEPmQe" alt="Proof" style="width:100%"></img>
        ...
        <div class="content">
        <img src="/w3images/p3.jpg" alt="Bear" style="width:100%"></img>
